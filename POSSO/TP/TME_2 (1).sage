...
print("\nVerification des résultats avec la fonction resultant de sage \n")
print(f1.resultant(g1))
print(g1.resultant(f1))
print(A.resultant(B))
print(B.resultant(A))
print(f2.resultant(g2))
print(g2.resultant(f2))
